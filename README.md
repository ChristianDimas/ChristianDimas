...
<td width="48%" valign="top">
  ...
  <p>
    Blappy Fird is a Flappy-Bird-like type of game where the player survives as long as possible by avoiding the pipes. What's different in my version of the game is that the pipes move up and down over time, increasing the difficulty and focus needed by the player. I did this project solo, so I'm responsible for the game design, art, and the programming side, but I got my SFXs from outside sources.
  </p>
  <p>
...
<td width="48%" valign="top">
  ...
  <p align="center">
    <img src="https://github.com/user-attachments/assets/8bfd33de-c37f-4c2d-b706-7cb191431a24" 
         alt="Scattered Gameplay" width="400" height="225"/>
  </p>
  <p>
